...
% the basic version for a test run, with finer data output

function [x, y, r, annDataPoints, annDataRadii, annDataEnergies, annDataTemps, ratios, annDataMarkovNo] = annealingbasicf(data, nCircles)
